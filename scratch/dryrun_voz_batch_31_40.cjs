...
function extractCompanyAndExactRole(postText) {
  ...
  if (compMatch) {
    ...
    const knownCompanies = ['Shopee', 'VNG', 'VNPay', 'Grab', 'Tiki', 'MoMo', 'VinBrain', 'FPT Software', 'Viettel', 'Zalo', 'NashTech', 'OneMount', 'Viet** Cyber Security', 'Splus Software Vietnam', 'Netcompany'];
...
async function runDryRunPages31To40() {
  console.log('===========================================================');
  console.log('HISTORICAL VOZ FINAL CONTROL DRY-RUN AUDIT — PAGES 31 TO 40');
  console.log('===========================================================');

  // Load all 13 accepted baseline records from pages 1-30 for deduplication
    ...
    try {
      ...
      for (const post of pagePosts.posts) {
        ...
        for (const line of lines) {
          ...
          // Normalize without appending '?' to topics
          ...
          // Deduplication against accepted baseline 1-30
          ...
          // Assign explicit triageReason for suspicious items
          let triageReason = null;
          if (!company) triageReason = 'Company attribution is unstated (company = null)';
          else if (!role) triageReason = 'Role attribution is unstated (role = null)';
          else if (company.includes('*')) triageReason = 'Company is partially anonymized';
          else if (!location) triageReason = 'Vietnam location attribution is unproven';
  ...
  console.log('===========================================================');
  console.log('PAGES 31-40 FINAL CONTROL DRY-RUN STATISTICS');
  console.log('===========================================================');
  ...
  console.log('===========================================================');
  console.log('FINAL STATE: PAGES_31_40_READY_FOR_FINAL_CONTROL_REVIEW');
  console.log('===========================================================');
}

runDryRunPages31To40().catch((err) => {
