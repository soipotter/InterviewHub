-- ============================================================================
-- MIGRATION: 20260811000019_approve_ingested_question_rpc.sql
-- DESCRIPTION: Security Definer RPC for approving and publishing ingested questions
-- ============================================================================
...
BEGIN
  ...
  INSERT INTO public.questions (
    ...
    ARRAY['Option A (Correct)', 'Option B', 'Option C', 'Option D'],
    'Option A (Correct)',
    'published'
  );
